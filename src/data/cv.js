...
export const phone = "+44 7534 551759";
export const email = "james.r.grantham@gmail.com";
export const portfolio = "jamesgrantham.me";
...
export const history = [
 {
   ...
   info: [
     ...
     "Developed a risk management app for a London based consultancy firm, for multiple users. Selecting from relevant templates (if account type permits) users complete the form and can export data and customised documents.",
   ],
 },
 {
